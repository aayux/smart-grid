...
#
# Created: Wed Jul  1 23:03:23 2015
...
class Ui_pgDialog(object):
    def setuppgUi(self, pgDialog):
        ...
        pgDialog.resize(400, 300)
        self.layoutWidget = QtGui.QWidget(pgDialog)
        self.layoutWidget.setGeometry(QtCore.QRect(60, 30, 281, 232))
        ...
        self.pgpushButton = QtGui.QPushButton(self.layoutWidget)
        self.pgpushButton.setObjectName(_fromUtf8("pgpushButton"))
        self.verticalLayout_4.addWidget(self.pgpushButton)
